...
function StatsRow(props) {
    return (
        <div className="row mx-0 py-2 border-bottom">
            ...
            <div className="col fw-600 d-flex align-items-lg-center align-items-end flex-lg-row flex-column justify-content-center">
                2323,23,2,3
                <span className='text-success d-lg-none d-block'>+23238</span>
            </div>
            <div className="col fw-600 d-lg-flex d-none align-items-center  text-success">+232323,2</div>
            <div className="col fw-600 d-lg-flex d-none align-items-center  text-success">+232323,2</div>
            <div className="col fw-600 d-lg-flex d-none align-items-center ">----</div>
            <div className="col fw-600 d-lg-flex d-none align-items-center ">2.3k</div>
            <div className="col fw-600 d-lg-flex d-none align-items-center ">1.3k</div>
        </div>
    )
}
    ...
    return (
        <div>
            <div className="d-flex pt-5 align-items-center flex-column">
                <h2 className="fw-600 fs-1">Top NFTs</h2>
                <p className='text-faded text-center pt-2'>The top NFTs on OpenSea, ranked by volume, floor price and other statistics.</p>
                <div className="row mx-0 col-lg-6 col-12">
            ...
            <div className="px-lg-5 ">
                <div className="row d-lg-flex d-none mx-0 mt-4 px-3 py-4 border-bottom">
                    ...
                    <div className="col fw-600">Volume</div>
                    <div className="col fw-600">24h %</div>
                    <div className="col fw-600">7d %</div>
                    <div className="col fw-600">Floor Price</div>
                    <div className="col fw-600">Owners</div>
                    <div className="col fw-600">Items</div>
                </div>
            ...
            <div className="d-flex justify-content-center my-4">
                    <Link to='' className='btn-dark'>  1 - 100 </Link>
                    <Link to='' className='btn-dark ms-2'>  101 - 201 </Link>
            </div>
